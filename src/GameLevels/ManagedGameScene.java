...
public abstract class ManagedGameScene extends ManagedScene {
	...
	public Scene onLoadingScreenLoadAndShown() {
		...
		this.mLoadingText = new Text(0, 0, mLOADING_STEP_TEXT_FONT, mFIRST_LOADING_STEP_TEXT, ResourceManager.getInstance().engine.getVertexBufferObjectManager());
	...
	public void onLoadingScreenUnloadAndHidden() {
		//detach & dispose of the loading screen resources
